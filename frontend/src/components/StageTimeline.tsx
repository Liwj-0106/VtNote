...
const diagnosticLabels: Record<string, string> = {
  ...
  local_asr_cancel_check_failed: "无法确认本地识别任务的取消状态。",
  moss_runtime_unavailable: "MOSS 识别运行环境不可用。",
  moss_runtime_timeout: "MOSS 识别超时。",
  moss_model_not_installed: "MOSS 模型尚未安装。",
  moss_model_load_failed: "MOSS 模型加载失败。",
  moss_cuda_unavailable: "MOSS 没有检测到可用的 CUDA 显卡。",
  moss_cuda_out_of_memory: "MOSS 识别时显存不足。",
  moss_inference_failed: "MOSS 识别失败。",
  moss_result_invalid: "MOSS 返回了无效的识别结果。",
  moss_result_truncated: "MOSS 识别结果可能不完整。",
  moss_progress_update_failed: "MOSS 识别进度保存失败。",
  speaker_map_publication_conflict: "MOSS 说话人结果与已保存内容冲突。",
